...
Vesper is a data-persistence framework that enables you to query and update data as `JSON`_, independent of the type of database that is actually storing the data. 
